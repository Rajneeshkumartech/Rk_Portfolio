        ...
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" asChild>
            <Button variant="ghost" className="absolute top-8 right-8 transition-opacity outline-none " size="icon-sm">
              <FaRegWindowClose className="text-3xl text-accent" />
