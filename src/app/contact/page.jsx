        ...
        <div className="flex flex-col lg:flex-row gap-6 xl:gap-[50px] items-center justify-between w-full">
          ...
          <div className="w-full lg:w-[55%] order-2 lg:order-none">
            ...
            <form className="flex flex-col gap-3 p-5 md:p-6 bg-[#27272c] rounded-xl w-full shadow-xl">
              <div>
                <h3 className="text-xl md:text-2xl text-accent font-semibold mb-0.5">Let&apos;s work together!</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-0.5">
                <Input type="text" placeholder="First Name" className="h-9 bg-primary/40 border-white/10 text-xs text-white placeholder:text-white/40 focus:border-accent transition-all px-4" />
                <Input type="text" placeholder="Last Name" className="h-9 bg-primary/40 border-white/10 text-xs text-white placeholder:text-white/40 focus:border-accent transition-all px-4" />
                <Input type="email" placeholder="Email Address" className="h-9 bg-primary/40 border-white/10 text-xs text-white placeholder:text-white/40 focus:border-accent transition-all px-4" />
                <Input type="tel" placeholder="Phone Number" className="h-9 bg-primary/40 border-white/10 text-xs text-white placeholder:text-white/40 focus:border-accent transition-all px-4" />
              </div>
              ...
              <Select>
                ...
                <SelectContent className="bg-[#27272c] border-white/10 text-white">
                  <SelectGroup>
                    <SelectLabel className="text-white/40 text-[11px]">Select a service</SelectLabel>
                    <SelectItem value="Frontend Development" className="text-xs">Frontend Development</SelectItem>
                    <SelectItem value="Backend & API Development" className="text-xs">Backend & API Development</SelectItem>
                    <SelectItem value="Full-Stack Web Apps" className="text-xs">Full-Stack Web Apps</SelectItem>
                    <SelectItem value="Performance Optimization / Bug Fixing" className="text-xs">Performance Optimization / Bug Fixing</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              ...
              <Textarea 
                ...
                className="min-h-[65px] xl:min-h-[80px] max-h-[100px] bg-primary/40 border-white/10 text-xs text-white placeholder:text-white/40 focus:border-accent resize-none transition-all px-4 py-2" 
              />
              ...
              {info.map((item, index) => (
                <li key={index} className="flex items-center gap-4 group">
                  ...
                  <div className="flex flex-col justify-center">
                    <p className="text-white/40 text-[10px] uppercase tracking-widest font-mono leading-none mb-0.5">{item.title}</p>
                    <h4 className="text-xs md:text-sm text-white font-medium break-all leading-tight">{item.description}</h4>
                  </div>
                </li>
              ))}
            </ul>
